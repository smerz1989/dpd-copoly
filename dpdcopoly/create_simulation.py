...
parser.add_argument('-s','--sequence',dest='sequence',type=str, help="Desired monomer sequence for each polymer (e.g. 'ABBAAB')")
...
sim = smc.Simulation(sequence=args.sequence,
